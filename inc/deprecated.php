...
if ( ! function_exists( 'itechstarter_adjust_body_class' ) ) {
	 ...
	 */
	function itechstarter_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'itechstarter_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function itechstarter_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'itechstarter' ),
		__( 'Previous', 'itechstarter' ),
		__( 'Next', 'itechstarter' ),
		__( 'About:', 'itechstarter' ),
		__( 'Profile', 'itechstarter' ),
		__( 'Posts by', 'itechstarter' ),
		__( 'Permanent Link:', 'itechstarter' ),
		__( 'in', 'itechstarter' ),
		__( 'Edit', 'itechstarter' ),
	);
}
